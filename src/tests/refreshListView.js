...
class RefreshListView extends Component {
 ...
 render() {
    return (
      <View style={{flex:1}}>
        <View style={{height: 50, backgroundColor: '#232325', justifyContent: 'center',alignItems: 'center'}}>
          <Text style={{fontWeight: 'bold', fontSize: 18,color: 'white', textAlign: 'center'}}>React Native PTR</Text>
        </View>
        <PullToRefresh
